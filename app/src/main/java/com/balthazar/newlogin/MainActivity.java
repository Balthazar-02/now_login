...
public class MainActivity extends AppCompatActivity {
    ...
    private void perforLogin() {
        ...
        if (!email.matches(emailPattern)) {
            ...
            progressDialog.setMessage(" please wait a minute for the Login ...");
            progressDialog.setTitle("Login");
            progressDialog.setCanceledOnTouchOutside(false);
            progressDialog.show();


            mAutjh.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                @Override
